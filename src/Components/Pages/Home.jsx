        ...
        >
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 mb-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-blue-600 dark:text-purple-400">
              Frontend  and MernStack Developer 
            </h2>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-lg mx-auto md:mx-0">
            ...
            I turn concepts into modern, responsive web applications with clean code and 
            thoughtful design. My focus is on delivering fast,
             user-friendly solutions that elevate the digital experience.”
          </p>

          <div className="flex gap-4 justify-center md:justify-start">
            <motion.a
             // href="https://drive.google.com/file/d/1eThAFXh88-SNcqv9mkan8izw6AHCNCVe/view?usp=drive_link"
              href="https://drive.google.com/file/d/1yhAP8SsWtvWLrM58-KfkgYPTfHaGauhK/view?usp=drive_link"
              target="_blank"
